...
export const policies: Record<string, Policy> = {
  terms: {
    ...
    content: [
      "Welcome to Anime Voice Pack Bundle, operated by Alpha Voice Assets LLC. By purchasing and downloading our digital products, you agree to comply with and be bound by the following terms and conditions of use.",
      "1. Digital Licensing: Upon purchase, Alpha Voice Assets LLC grants you a non-exclusive, non-transferable, revocable license to use the voice samples for personal and commercial projects. This license is limited to soundboard setups, video editing, and content creation.",
      ...
      "5. Limitations: In no event shall Alpha Voice Assets LLC, Anime Voice Pack Bundle, or its founders be liable for any damages arising out of the use or inability to use the products."
    ]
  },
  privacy: {
